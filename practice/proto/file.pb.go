...
func (x *FileResponse) GetResponse() string {
	if x != nil {
		return x.Response
	}
	return ""
...
var file_file_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x67, 0x72, 0x70, 0x63, 0x22, 0x3d, 0x0a, 0x0b, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x65,
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x2a, 0x0a, 0x0c, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x73,
	...
	0x65, 0x32, 0x43, 0x0a, 0x04, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x3b, 0x0a, 0x08, 0x53, 0x65, 0x6e,
	0x64, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x15, 0x2e, 0x66, 0x69, 0x6c, 0x65, 0x67, 0x72, 0x70, 0x63,
	0x2e, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x66,
	0x69, 0x6c, 0x65, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70,
...
var file_file_proto_goTypes = []interface{}{
	(*FileRequest)(nil),  // 0: filegrpc.FileRequest
	(*FileResponse)(nil), // 1: filegrpc.FileResponse
}
var file_file_proto_depIdxs = []int32{
	0, // 0: filegrpc.File.SendFile:input_type -> filegrpc.FileRequest
	1, // 1: filegrpc.File.SendFile:output_type -> filegrpc.FileResponse
...
type FileClient interface {
	SendFile(ctx context.Context, in *FileRequest, opts ...grpc.CallOption) (*FileResponse, error)
}
...
func (c *fileClient) SendFile(ctx context.Context, in *FileRequest, opts ...grpc.CallOption) (*FileResponse, error) {
	out := new(FileResponse)
	err := c.cc.Invoke(ctx, "/filegrpc.File/SendFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FileServer interface {
	SendFile(context.Context, *FileRequest) (*FileResponse, error)
}
...
func (*UnimplementedFileServer) SendFile(context.Context, *FileRequest) (*FileResponse, error) {
...
func _File_SendFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileServer).SendFile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/filegrpc.File/SendFile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServer).SendFile(ctx, req.(*FileRequest))
	}
